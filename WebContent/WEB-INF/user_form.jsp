<%--General Form of user, teacher or student creation or modification--%>
<%--Value of each field is the value registered in the user bean. If it's a creation form nothing appears in the fields,
if it's a modification form or if this form is displayed after an error
...
<%--if this form is used for a modification, username can't be modified --%>
<c:choose>
