...
//Forbids access to every one who wants to displays the privileges but doesn't have the right privilege.
//Instead, the "not available page" will be displayed.

public class DisplayPrivsFilter implements Filter {
