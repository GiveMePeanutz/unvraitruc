...
//Forbids access to every one who wants to subscribe to a course course but doesn't have the right privilege.
//Instead, the "not available page" will be displayed.

public class CourseSubscriptionFilter implements Filter {
    ...
    public void doFilter( ServletRequest req, ServletResponse res,
        ...
        if ( !menus.contains( "Course Subscription" ) ) {
