...
//Forbids access to every one who wants to displays the users but doesn't have the right privilege.
//Instead, the "not available page" will be displayed.

public class DisplayUsersFilter implements Filter {
    ...
    public void doFilter( ServletRequest req, ServletResponse res,
        ...
        if ( !menus.contains( "Display Users" ) ) {
