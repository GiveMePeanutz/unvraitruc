...
//Forbids access to every one who wants to delete a teacher but doesn't have the right privilege.
//Instead, the "not available page" will be displayed.

public class DeleteTeacherFilter implements Filter {
    ...
    public void doFilter( ServletRequest req, ServletResponse res,
        ...
        if ( menus.contains( "Delete Teacher" ) ) {
