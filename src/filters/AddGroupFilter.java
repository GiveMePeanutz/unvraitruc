...
//Forbids access to every one who wants to add a group but doesn't have the right privilege.
//Instead, the "not available page" will be displayed.

public class AddGroupFilter implements Filter {
