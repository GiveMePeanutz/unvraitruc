...
public class KmeansDataDaoImpl implements KmeansDataDao {
    ...
    private static final String SQL_USER_ACTIVITY_COUNT  = "SELECT username, count(pageName) FROM transaction_table GROUP BY username";
    private static final String SQL_GROUP_ACTIVITY_COUNT = "SELECT groupName, count(pageName) FROM transaction_table f, user_group ug WHERE f.username=ug.username GROUP BY groupName";

    private static final String SQL_USER_COUNT           = "SELECT count(distinct username) FROM transaction_table";
    private static final String SQL_GROUP_COUNT          = "SELECT count(distinct groupName) FROM user_group WHERE username IN ( SELECT username FROM transaction_table )";
    ...
    /*
     * Retrieves from the database user activity in the form of an array of
     * KmeansDataType
     */
    @Override
    public KmeansDataType[] getUserActivity() throws DAOException {
        ...
        try {
            ...
            // Prepared statement of the query in charge of retrieving the
            ...
            // Prepared statement of the query in charge of retrieving every
            // user and their
            ...
            // For every line retrieved the data is loaded into the array of
            // KmeansDataType
        ...
        // Returns the array of KmeansDataType containing every actuve user's
        // username associated
    ...
    /*
     * Retrieves from the database group activity in the form of an array of
     * KmeansDataType
     */
    @Override
    public KmeansDataType[] getGroupActivity() throws DAOException {
        ...
        // Returns the array of KmeansDataType containing every active group's
        // groupName associated
        // with their activity count
        return result;
    }
    ...
    public int countActiveUsers() throws DAOException {
        ...
        try {
            ...
            // Prepared statement of the query in charge of retrieving the count
            // of active users
