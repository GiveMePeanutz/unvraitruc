		...
		try {
			...
			for (String username : course.getUsernames()) {
				preparedStatement2 = initialisationRequetePreparee( connexion,
	                    SQL_INSERT_COURSE_USER, true, username, course.getCourseName() );
	...
	public List<Course> list() throws DAOException {
        ...
        try {
            ...
            while ( resultSet.next() ) {
            	preparedStatement2 = initialisationRequetePreparee(connection, SQL_SELECT_COURSE_USERS, false, resultSet.getString("courseName") );
                resultSet2 = preparedStatement2.executeQuery();
